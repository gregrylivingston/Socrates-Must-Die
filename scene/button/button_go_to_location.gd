...
func _ready():
	...
	if isTiny:
		...
		add_theme_stylebox_override("pressed	",load("res://scene/location/locationButtonStyleBoxTinyHover.tres"))
		add_theme_stylebox_override("focus",load("res://scene/location/locationButtonStyleBoxTinyHover.tres"))
